...
# test_path = '/home/allen/dl_grasp/src/data_expend/expand_data/5object_100_2020-11-11_07_50_16_.csv'
...
save_path = '/home/allen/dl_grasp/src/train/Save_net/fiveobject/cnn_fiveobject_dropoutv3'
EPOCHS = 500
batch_size = 10
...
def main():
    ...
    result = CNN.fit_generator(training_generator,epochs=EPOCHS,verbose=1,validation_data=test_generator,callbacks=[custom_early_stopping])
