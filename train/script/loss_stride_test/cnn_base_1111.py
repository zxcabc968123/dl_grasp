...
save_path = '/home/allen/dl_grasp/src/train/Save_net/5object_stride_check/1111'
model_type = 'Base mode(stride 1111)'
EPOCHS = 1000
batch_size = 50
...
def main():
    ...
    CNN.add(layers.Conv2D(16,(3,3),activation=lrelu,input_shape=(480,640,1),strides=(1,1)))
    #add pooling layer 3*3 478*638
    CNN.add(layers.MaxPooling2D((2,2)))
    #add convolution layer filter 16 3*3 activation funtion relu 239*319
    CNN.add(layers.Conv2D(16,(3,3),activation=lrelu,strides=(1,1)))
