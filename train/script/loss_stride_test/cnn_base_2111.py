...
save_path = '/home/allen/dl_grasp/src/train/Save_net/5object_stride_check/2111'
model_type = 'Base mode(stride 2111)'
EPOCHS = 1000
batch_size = 50
...
def main():
    ...
    CNN.add(layers.Conv2D(16,(3,3),activation=lrelu))
